<template>
    <div class="card docs">
        ...
        <p>
            Freya is an application template for Vue 3 based on <a href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</a>, the recommended way to start a <strong>Vite-powered</strong> Vue projects.
        ...
        <p>Next step is running the application using the serve script and navigate to <i>http://localhost:5173/</i> to view the application. That is it, you may now start with the development using the Freya template.</p>

        <pre class="app-code"><code>npm run dev</code></pre>

        <h4>Structure</h4>
        <p>Freya consists of a couple folders, demos and layout have been separated so that you can easily remove what is not necessary for your application.</p>
...
&#125;,</code></pre>
        ...
        <p>Only the folders that are related to the layout needs to move in to your project. We've created a short tutorial with details. It is based on Sakai but flow is exactly the same with Freya.</p>
        ...
        <p>
            Freya provides 20 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside <span class="text-primary font-medium">public/layout/styles/theme/</span> folder such as
...
@import '../_extensions';
        ...
        <p>
            Freya includes a simplified version of the <a href="https://www.primefaces.org/designer/primevue">PrimeVue Theme Designer</a> that only includes the main SASS structure. Full list of SASS variables to customize the components further is
