        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    ...
                    <Avatar label="+2" shape="circle" size="large" class="text-white" :style="{ 'background-color': '#9c27b0' }"></Avatar>
                </AvatarGroup>

                <h5>Label - Circle</h5>
                <Avatar label="P" class="mr-2" size="xlarge" shape="circle"></Avatar>
                <Avatar label="V" class="mr-2 text-white" size="large" :style="{ 'background-color': '#2196F3' }" shape="circle"></Avatar>
                <Avatar label="U" class="mr-2 text-white" :style="{ 'background-color': '#9c27b0' }" shape="circle"></Avatar>
