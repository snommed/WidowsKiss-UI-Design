            ...
            <div class="col-12 xl:col-6">
                <div class="card">
                    <div class="flex w-full justify-content-between align-items-center">
                        <h4>Orders</h4>
                        <Button type="button" severity="secondary" text @click="menu.toggle($event)"><i class="pi pi-search mr-2"></i> Show</Button>
                    </div>
                    ...
                    <div class="grid mt-3">
                        ...
                        <div class="col-12 mt-5">
                            <Chart ref="chart" :height="340" type="line" :data="ordersChart" :options="ordersChartOptions" id="order-chart"></Chart>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="flex justify-content-between">
                        ...
                        <Dropdown
                            ...
                            class="w-9rem"
                            :pt="{
                                input: { class: 'flex align-items-center' }
                            }"
                        />
                    </div>
                ...
                <div class="card">
                    ...
                    <ul class="list-none p-0 m-0">
                        ...
                        <template v-for="(product, i) in products" :key="{ i }">
                            <li v-if="i < 7" class="flex align-items-center justify-content-between p-3 surface-border" :class="{ 'border-bottom-1': i !== 6 }">
            ...
            <div class="col-12 lg:col-8">
                <div class="card">
                    ...
                    <div class="flex justify-content-center align-items-center">
                        <Chart type="pie" :height="500" :data="revenueChart" :options="revenueChartOptions" :style="{ width: '50%' }"></Chart>
                    </div>
                </div>
                        ...
                        <li v-for="(member, i) in teamMembers" :key="i" class="p-3 surface-border" :class="{ 'border-bottom-1': i !== 4 }">
                            <div class="flex justify-content-between align-items-center">
                                ...
                                <div class="flex gap-2">
                                    <Button class="p-button" severity="success" rounded icon="pi pi-envelope"></Button>
                                    <Button class="p-button" severity="warning" rounded icon="pi pi-cog"></Button>
                                </div>
                            </div>
                        </li>
                    </ul>
