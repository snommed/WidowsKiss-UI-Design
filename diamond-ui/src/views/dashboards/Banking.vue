    ...
    <div class="layout-dashboard">
        <div class="grid">
            <div class="col-12 flex align-items-center justify-content-between flex-wrap gap-5">
                ...
                <div class="mx-auto sm:mx-0">
                    <Button type="button" class="mr-1 sm:mr-3" severity="secondary" rounded outlined icon="pi pi-calendar" />
                    <Button type="button" severity="secondary" rounded icon="pi pi-plus" label="Add Quick Action" iconPos="right" />
                </div>
            </div>
            <div class="col-12 md:col-4" v-for="(metric, index) in metrics" :key="metric.title">
                <div class="card flex w-full relative h-14rem overflow-hidden" @mouseenter="showMetricButton(index)" @mouseleave="hideMetricButton(index)">
                    ...
                    <Button type="button" label="View Detail" icon="pi pi-eye " class="metric-button hidden font-semibold absolute p-ripple" severity="secondary" rounded :style="{ borderRadius: '50px', left: '36%', bottom: '10%' }"> </Button>
                </div>
            </div>
            <div class="h-full col-12 xl:col-8">
                <div class="card">
                    <div class="flex flex-column md:flex-row md:justify-content-between align-items-center mb-2">
                        ...
                        <Button type="button" text>See All Transactions</Button>
                    </div>
                    <DataTable
                        :value="transactions"
                        :rows="5"
                    ...
                    >
                        ...
                        <Column field="amount">
                            <template #body="slotProps">
                                <span class="transaction-amount" :class="{ 'text-green-700': slotProps.data.received }">
                        ...
                        <Column style="text-align: center">
                            <template #body>
                                <Button icon="pi pi-ellipsis-v" severity="secondary" text @click="toggle"></Button>
                ...
                <div class="card h-full">
                    ...
                    <div class="grid flex-column sm:flex-row grid-nogutter border-round-xl mt-4">
                        ...
                        <div class="col-12 sm:col-6 p-4 border-round-bottom-xl sm:border-noround-left sm:border-round-right-xl flex align-items-center justify-content-center sm:justify-content-end" :style="{ backgroundColor: '#4DB6AC' }">
                            <Button class="p-button surface-section font-semibold" severity="success" rounded text :style="{ color: '#4DB6AC' }" label="View Details" icon="pi pi-eye font-semibold" iconPos="right" type="button"></Button>
                        </div>
                    </div>
                    ...
                    <a role="button" v-ripple class="p-ripple w-full border-1 border-dashed surface-border h-4rem border-round-xl mt-4 flex justify-content-center align-items-center cursor-pointer select-none">
            ...
            <div class="col-12 xl:col-6">
                <div class="card">
                    <h4>Savings</h4>
                    <Chart type="bar" :height="470" :data="barData" :options="barOptions"></Chart>
                </div>
            </div>
        </div>
    </div>
