...
&#125;,</code></pre>
        ...
        <p>
            Diamond provides 30 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside <span class="text-primary font-medium">public/layout/styles/theme/</span> folder such as
...
@import '../_extensions';</code></pre>
        ...
        <ul class="pl-5 line-height-3">
            ...
            <li>Create a file named "_mymenu.scss" under <span class="font-semibold">assets/layout/sidebar/themes</span> folder.</li>
            <li>Define the variables listed below in your file.</li>
            <li>Import the file at <span class="font-semibold">assets/layout/layout.scss</span>.</li>
